...
(с идентификатором поля 10123, в аккаунте testo.planfix.ru) (идентификаторы полей можно получить методом [contact.get](Интеграции/ПланФикс_API_contact.get.md) на шаблоне контакта с этим полем) 
...
(с идентификатором поля 10123, в аккаунте testo.planfix.ru) (идентификаторы полей можно получить методом [task.get](Интеграции/ПланФикс_API_task.get.md) на шаблоне задачи с этим полем, справка фильтрам - [ПланФикс API:Фильтры задач](Задачи/ПланФикс_API_Фильтры_задач.md)) 
