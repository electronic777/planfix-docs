(перенаправлено с «[Post-запросы](index.php.md "Post-запросы")»)


ПланФикс работает с HTTP-запросами через [автоматические сценарии](Автоматические_сценарии.md "Автоматические сценарии") и [вебхуки](Входящие_вебхуки.md "Входящие вебхуки"), используя следующие методы: 
...
## Примеры HTTP-запросов и разбор ответов
  ...
  * [GET-запрос: получение курса валют](GET-запрос__получение_курса_валют.md "GET-запрос: получение курса валют")

  * [POST-запрос: трекинг посылок](POST-запрос__трекинг_посылок.md "POST-запрос: трекинг посылок")

  * [POST-запрос в ЮКассу: ссылка на оплату](POST-запрос_в_ЮКассу__ссылка_на_оплату.md "POST-запрос в ЮКассу: ссылка на оплату")

  * [Приём HTTP-запросов при помощи входящих вебхуков](Входящие_вебхуки.md "Входящие вебхуки")
