Функция позволяет получить список доступных текущему сотруднику фильтров контактов для функции [contact.getList](ПланФикс_API_contact.getList.md "ПланФикс API contact.getList"). Формат вызова функции: 
