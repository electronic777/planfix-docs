...
analitic.id | int | идентификатор аналитики | список аналитик можно получить с помощью [ списка доступных аналитик в ПланФикс ](Интеграции/ПланФикс_API_analitic.getList.md)  
...
action |  | комментарий, описание параметра смотри в разделе [ Получить комментарий](Интеграции/ПланФикс_API_action.get.md) |   
