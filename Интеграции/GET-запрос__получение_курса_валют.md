Получите курс валют из ЦБ РФ прямо в ПланФикс с помощью [автоматического сценария](../Автоматизация/Автоматические_сценарии.md). Для настройки используйте XML-данные, которые можно получить на сайте Центробанка России по [ссылке](http://www.cbr.ru/scripts/XML_daily.asp). 
