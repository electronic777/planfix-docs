...
sortType | enum | тип сортировки | список допустимых значений смотри в разделе [типы сортировок пользователей](Интеграции/ПланФикс_API_Типы_сортировок_пользователей.md)  
