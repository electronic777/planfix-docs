...
role | enum | роль пользователя в системе | необязательное поле. доступно для изменения только пользователям с правами администратор. полный список смотри в разделе [роли пользователей](Интеграции/ПланФикс_API_Роли_пользователей.md)  

status | enum | статус | необязательное поле. доступно для изменения только пользователям с правами администратор. список допустимых значений смотри в разделе [статусы пользователей](Задачи/ПланФикс_API_Статусы_пользователей.md)  

password | string | пароль | необязательное поле   

birthdate | DateTime | дата рождения | необязательное поле   

sex | enum | пол сотрудника | необязательное поле. список допустимых значений смотри в разделе [пол сотрудника](Контакты/ПланФикс_API_Пол_сотрудника.md)  
