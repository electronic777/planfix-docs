...
handbook.id | int | идентификатор справочника | получается в результате выполнения функции [получить описание аналитики](ПланФикс_API_analitic.getOptions.md "ПланФикс API analitic.getOptions")  
