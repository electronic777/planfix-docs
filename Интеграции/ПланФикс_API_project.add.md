...
status | enum | статус создаваемого проекта | перечень допустимых значений для данного поля смотри в разделе [статусы проектов](../Задачи/ПланФикс_API_Статусы_проектов.md)  
