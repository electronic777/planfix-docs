Вы можете [подключить](Интеграции/Интеграции.md) к ПланФиксу чат-ботов Viber для приема и обработки сообщений клиентов. 
...
## Возможности
  ...
  * Доступны [быстрые ответы](Прочее/Быстрые_ответы.md), для ответа на часто задаваемые вопросы клиентов.
...
В этом же окне: 
  ...
  * Укажите, кого [дополнительно подключать к общению в качестве исполнителей](Контакты/Дополнительное_подключение_сотрудников.md).
