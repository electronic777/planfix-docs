Для общения ПланФикса и ЮКассы будем использовать [автоматический сценарий](../Автоматизация/Автоматические_сценарии.md) c [HTTP-запросом](HTTP-запросы.md). Пример, который настроим, позволит автоматически формировать ссылку на оплату и отправлять её клиенту. 
