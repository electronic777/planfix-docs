В ПланФикс можно [интегрировать](Интеграции.md) чат-бота с искусственным интеллектом [ChatGPT](https://chat.openai.com/). Для работы требуется тариф "Профессионал". В автоматических сценариях используйте операцию «**Послать запрос к ChatGPT** ». 
...
Вы можете использовать и другие генеративные языковые модели в ПланФиксе: [Yandex GPT](Yandex_GPT.md), [ProxyAPI](ProxyAPI.md).
