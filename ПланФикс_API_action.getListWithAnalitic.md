...
analitic.id | int | идентификатор аналитики | список аналитик можно получить с помощью [ списка доступных аналитик в ПланФикс ](ПланФикс_API_analitic.getList.md "ПланФикс API analitic.getList")  
...
action |  | комментарий, описание параметра смотри в разделе [ Получить комментарий](ПланФикс_API_action.get.md "ПланФикс API action.get") |   
