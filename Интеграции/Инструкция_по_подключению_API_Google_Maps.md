API Google Maps используется для перевода данных, содержащих адреса или названия объектов, из текстового вида в вид, предназначенный для отображения объекта на карте. Эта возможность используется в [ интеграции ПланФикса с картами](Интеграции/Интеграция_с_картами.md). 
...
![AmPPt9.png](images/AmPPt9.png)
  ...
  * Скопируйте полученный ключ API. Он необходим для подключения [ интеграции с картами](Интеграции/Интеграция_с_картами.md) в ПланФиксе.
...
После включения всех необходимых API, можно переходить к включению [ интеграции с картами](Интеграции/Интеграция_с_картами.md) в интерфейсе ПланФикса. 
