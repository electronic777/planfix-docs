...
Сохраните изменения. После этого в каждом [ фильтре контактов](../Контакты/Фильтры_контактов.md) появится возможность включать [автоматический экспорт отобранных контактов](../Коммуникации/Сервисы_рассылки_e-mail.md) в eSputnik. 
