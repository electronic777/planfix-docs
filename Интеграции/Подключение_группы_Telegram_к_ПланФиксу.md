ПланФикс можно подключить к группе [Telegram](Telegram.md), чтобы получать из нее сообщения и отвечать на них. 
...
## Подключение
  ...
  * [ Авторизуйте Telegram в ПланФиксе](Авторизация_Telegram_в_ПланФиксе.md).

  * Добавьте в группу [ бота ПланФикса](Работа_с_ботом_ПланФикса_для_Telegram.md) или [собственного бота](Как_создать_собственного_бота_Telegram.md).
...
## Ограничения
  ...
  * При использовании интеграции есть ряд ограничений. Они описаны в основной статье про [ интеграцию с Телеграм](Telegram.md).
