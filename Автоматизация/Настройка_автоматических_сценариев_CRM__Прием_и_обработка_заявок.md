Одно из правил, которым руководствуется команда ПланФикса: «Работать должны роботы». Этому принципу следует и конфигурация [ CRM: Прием и обработка заявок](CRM/CRM__Прием_и_обработка_заявок.md). Когда что-то будет идти не так, как запланировано уже настроенными автоматическими сценариями конфигурации, в уведомлениях вы увидите сообщения от робота Евы. Её работа видна в следующих случаях: 
...
Описанная автоматизация, работающая на базе [ автоматических сценариев](Автоматизация/Автоматические_сценарии.md), может быть выключена или настроена для нужд именно вашей компании. Для этого: 
