...
sort | enum | тип сортировки | список допустимых значений смотри в разделе [типы сортировок файлов](ПланФикс_API_Типы_сортировок_файлов.md "ПланФикс API:Типы сортировок файлов")  
