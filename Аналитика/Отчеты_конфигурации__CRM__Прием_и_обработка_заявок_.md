В конфигурацию [ CRM: Прием и обработка заявок](CRM/CRM__Прием_и_обработка_заявок.md) добавлены несколько стандартных отчетов. Они позволяют увидеть сводную информацию по запросам за определенный период. Параметры отчетов можно менять: 
...
Помимо стандартных отчетов вы можете [ сформировать любой отчет](Аналитика/Как_создать_новый_отчет_.md), который будет учитывать специфические показатели именно вашей компании.
