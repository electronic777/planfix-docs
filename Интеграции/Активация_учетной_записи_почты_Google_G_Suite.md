...
Сервис уведомит вас, что через 24 часа будет обновлена информация о настройках безопасности и вы сможете [ продолжить настройку](Использование_учетных_записей_почты_Google.md).
