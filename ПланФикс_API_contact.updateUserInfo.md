...
user.status | enum | статус | список допустимых значений смотри в разделе [статусы пользователей](ПланФикс_API_Статусы_пользователей.md "ПланФикс API:Статусы пользователей")  
