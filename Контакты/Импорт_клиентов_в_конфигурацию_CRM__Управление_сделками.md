Импорт позволяет загружать в конфигурацию данные клиентов из других источников, а также обновлять их. С общими правилами импорта контактов в ПланФикс можно ознакомиться в [справке](Контакты/Импорт_контактов.md). 
