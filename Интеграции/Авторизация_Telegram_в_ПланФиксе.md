...
Для прохождения авторизации: 
  ...
  * Зайдите в свою [карточку пользователя](Интерфейс/Страница_пользователя.md) ПланФикса и в окошке с Телеграмом переместите слайдер вправо, нажав на него:
...
Это означает, что авторизация пройдена и вы можете пользоваться всеми возможностями [ интеграции ПланФикса и Telegram](Интеграции/Telegram.md). 
