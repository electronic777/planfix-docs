В ПланФикс можно [интегрировать](Интеграции/Интеграции.md) чат-бота с искусственным интеллектом [ChatGPT](https://chat.openai.com/). Для работы требуется тариф "Профессионал". В автоматических сценариях используйте операцию «**Послать запрос к ChatGPT** ». 
...
## Подключение
  ...
  * Затем из маркетплейса ПланФикса [установите](Настройка/Инструкция_по_установке_конфигурации.md) конфигурацию «Запрос к ChatGPT».
...
Вы можете использовать и другие генеративные языковые модели в ПланФиксе: [Yandex GPT](Интеграции/Yandex_GPT.md), [ProxyAPI](Интеграции/ProxyAPI.md).
