...
| int - идентификатор группы, можно получить методом [ contact.getGroupList](ПланФикс_API_contact.getGroupList.md "ПланФикс API contact.getGroupList")  
...
| int - номер шаблона, general в ответе метода [ contact.getList](ПланФикс_API_contact.getList.md "ПланФикс API contact.getList") с target = template
