(перенаправлено с «[Как добавить действие с помощью e-mail?](../Прочее/index.php.md)»)


Любой ответ на [ письмо-уведомление](../Коммуникации/Получение_уведомлений_на_E-mail.md) из задачи ПланФикса будет добавлен в эту задачу новым [комментарием](../Коммуникации/Комментарии.md). При этом: 
...
Уведомления о комментариях, пришедших в задачу по почте, получают: 
  ...
  * Постановщик и исполнители, если: 
    ...
    * Письмо является ответом на [уведомление по почте](../Коммуникации/Получение_уведомлений_на_E-mail.md).
