...
file.sourceType | enum | тип источника | список допустимых значений смотри в [типы источников файла](Интеграции/ПланФикс_API_Типы_источников_файла.md), допустимые значения FILESYSTEM и INTERNET   
