...
actionType | enum | тип действия, необязательный параметр | список возможных значений смотри в разделе [типы действий](ПланФикс_API_Список_типов_действий.md "ПланФикс API:Список типов действий")  
