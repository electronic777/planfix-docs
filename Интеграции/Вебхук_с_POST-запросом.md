Для того, чтобы понять как работают [вебхуки](Прочее/Входящие_вебхуки.md) с POST-запросом, рассмотрим простой пример создания контакта в ПланФиксе после заполнения формы обратной связи на сайте. 
