...
signature | string(32) | не обязательна, md5 от имени функции, значений всех полей, исключая _signature_ | подробное описание алгоритма формирования подписи смотри в разделе [ПланФикс API:Формирование цифровой подписи](ПланФикс_API_Формирование_цифровой_подписи.md)  
...
### Перейти
  ...
  * [Коды ошибок](../Общие/Коды_ошибок.md)

  * [Пример кода на PHP](ПланФикс_API_Пример_аутентификации_на_php.md)


[Категории](Служебная_Категории.md "Служебная:Категории \(страница не существует\)"): 


  * [Страницы, использующие устаревший тег source](../Прочее/index.php.md)

  * [Страницы с ошибками в подсветке синтаксиса](../Прочее/index.php.md)
