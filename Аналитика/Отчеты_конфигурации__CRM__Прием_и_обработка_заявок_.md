...
Помимо стандартных отчетов вы можете [ сформировать любой отчет](Как_создать_новый_отчет_.md), который будет учитывать специфические показатели именно вашей компании.
