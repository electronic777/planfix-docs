В ПланФиксе есть два способа получения данных отчетов по API: 
  ...
  * Сформировать [отчет по расписанию](Отчет_по_расписанию.md "Отчет по расписанию") и получить его данные через [REST API](REST_API.md "REST API").

  * Запросить генерацию отчета через [REST API](REST_API.md "REST API") и получить его данные, когда он будет сформирован.
