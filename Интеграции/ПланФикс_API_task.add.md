...
template | id | идентификатор шаблона задачи | id в ответе [task.getList](ПланФикс_API_task.getList.md) с target = template   
...
status | enum/int | статус задачи | Допустимы значения из раздела [Системные статусы задач](../Задачи/ПланФикс_API_Системные_статусы_задач.md) или идентификаторы статусов, полученные в результате вызова функции [taskStatus.getListOfSet](ПланФикс_API_taskStatus.getListOfSet.md)  

statusSet | int | процесс задачи | Идентификаторы процессов можно получить в результате вызова функции [taskStatus.getSetList](ПланФикс_API_taskStatus.getSetList.md)  
...
owner.id | int | идентификатор пользователя | если это контакт - нужно использовать userid из ответа [contact.get](ПланФикс_API_contact.get.md)  
...
workers.users.id | int | идентификатор пользователя которому поставлена задача | для контактов - нужно использовать userid из ответа [contact.get](ПланФикс_API_contact.get.md)  
...
members.users.id | int | идентификатор участника задачи | для контактов - нужно использовать userid из ответа [contact.get](ПланФикс_API_contact.get.md)  
