...
sex | enum | пол | допустимые значения смотри в разделе [пол клиента](ПланФикс_API_Пол_клиента.md "ПланФикс API:Пол клиента"), если значение не установлено, то значение пусто   
