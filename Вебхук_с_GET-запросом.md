Для того, чтобы понять как работают [вебхуки](Входящие_вебхуки.md "Входящие вебхуки") с GET-запросом, сформируем ссылку, которая будет создавать новые задачи в ПланФиксе. 
...
Добавление значений в параметры ссылки вебхука можно и нужно автоматизировать, применяя различные [переменные](Переменные_в_шаблонах_задач.md "Переменные в шаблонах задач"). Подробно об этом читайте в [блоге](https://planfix.com/ru/blog/vhodyashchie-vebhuki-poluchaem-dannye-v-planfiks-bez-promedleniya/).
