Функция позволяет получить список доступных текущему сотруднику фильтров контактов для функции [contact.getList](ПланФикс_API_contact.getList.md). Формат вызова функции: 
...
signature | string(32) | md5 от имени функции, значений всех полей, исключая _signature_ | подробное описание алгоритма формирования подписи смотри в разделе [ПланФикс API:Формирование цифровой подписи](ПланФикс_API_Формирование_цифровой_подписи.md)  
