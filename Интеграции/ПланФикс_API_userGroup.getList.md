...
sortType | enum | тип сортировки | не обязательный параметр. список допустимых значений смотри в разделе [типы сортировок для групп](Интеграции/ПланФикс_API_Типы_сортировок_для_групп.md)  
