Вы можете создать собственного бота [Telegram](Telegram.md "Telegram") и подключить его в ПланФикс. Сообщения, отправленные такому боту вашими клиентами или коллегами, станут [ задачами](Задачи.md "Задачи") в ПланФиксе. Комментарии, добавленные в задачу с уведомлением внешнего абонента, будут отправлены ему в Telegram от имени бота. Это позволяет организовывать обработку заявок клиентов с мобильных устройств, работу службы поддержки и т.п. 
...
**Важно:** При настройке интеграции есть возможность создавать новую задачу, если нет [ активных](Тип_статуса_задачи.md "Тип статуса задачи") (то есть в любом активном статусе) задач по обращениям от клиента: 
