...
filters |  | дополнительные сложные фильтры | перечень и формат допустимых значений смотри в разделе [фильтры контактов](ПланФикс_API_Фильтры_контактов.md "ПланФикс API:Фильтры контактов")  
...
идентификатор фильтра контактов | доступные фильтры можно получить функцией [contact.getFilterList](ПланФикс_API_contact.getFilterList.md "ПланФикс API contact.getFilterList") |   
...
sex | enum | пол | допустимые значения смотри в разделе [пол клиента](ПланФикс_API_Пол_клиента.md "ПланФикс API:Пол клиента")  
