(перенаправлено с «[Instagram](Общие/index.php.md)»)


[Интеграция](Интеграции/Интеграции.md) с Instagram позволяет отвечать на комментарии под постами и сообщения в директ от контактов прямо из ПланФикса. 
...
## Правила для ответа на комментарии под публикациями
  ...
  * **Работа с типовыми вопросами**. В переписке с клиентами для ответа можно использовать механизм [быстрых ответов](Прочее/Быстрые_ответы.md).
...
## Дополнительно
  ...
  * **Доступные интеграции**. Ознакомьтесь с [перечнем сервисов](Интеграции/Интеграции.md) в справке.
  ...
  * **Сторонние сервисы для подключения** — до появления официальной интеграции ПланФикса и Instagram взаимодействие осуществлялось через сторонние сервисы: 
    ...
    * [ i2crm](Интеграции/Интеграция_ПланФикса_и_Instagram_через_i2crm.md)
