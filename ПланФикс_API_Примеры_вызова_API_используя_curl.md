...
(с идентификатором поля 10123, в аккаунте testo.planfix.ru) (идентификаторы полей можно получить методом [contact.get](ПланФикс_API_contact.get.md "ПланФикс API contact.get") на шаблоне контакта с этим полем) 
...
(с идентификатором поля 10123, в аккаунте testo.planfix.ru) (идентификаторы полей можно получить методом [task.get](ПланФикс_API_task.get.md "ПланФикс API task.get") на шаблоне задачи с этим полем, справка фильтрам - [ПланФикс API:Фильтры задач](ПланФикс_API_Фильтры_задач.md "ПланФикс API:Фильтры задач")) 
