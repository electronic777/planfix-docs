...
owner.id | int | идентификатор автора комментария | если это контакт - нужно использовать userid из ответа [contact.get](Интеграции/ПланФикс_API_contact.get.md)  

dateTime | [ DateTime](Интеграции/ПланФикс_API_Тип_данных_DateTime.md) | дата/время создания — не обязательный, по умолчанию текущие | может заполняться, только если авторизация была сделана под сотрудником с правами администратора   
...
itemData.fieldId | int | идентификатор параметра | идентификатор параметра равен [field.id](Интеграции/ПланФикс_API_analitic.getOptions.md)  
