(перенаправлено с «[Как добавить действие с помощью e-mail?](index.php.md "Как добавить действие с помощью e-mail?")»)


Любой ответ на [ письмо-уведомление](Получение_уведомлений_на_E-mail.md "Получение уведомлений на E-mail") из задачи ПланФикса будет добавлен в эту задачу новым [комментарием](Комментарии.md "Комментарии"). При этом: 
...
Уведомления о комментариях, пришедших в задачу по почте, получают: 
  ...
  * Постановщик и исполнители, если: 
    ...
    * Письмо является ответом на [уведомление по почте](Получение_уведомлений_на_E-mail.md "Получение уведомлений на E-mail").
...
Если ответ на комментарий придет с [email-адреса](Работа_в_ПланФиксе_с_помощью_e-mail.md "Работа в ПланФиксе с помощью e-mail"), которого нет в вашем аккаунте, то: 
...
Для более гибкого управления добавляемыми в задачу комментариями из почты, вы можете настроить [правила обработки писем, поступающих в задачу](Правила_добавления_писем_в_существующие_задачи.md "Правила добавления писем в существующие задачи").
