Сложные фильтры в [REST API](Интеграции/REST_API.md) ПланФикса применяются в методе «/task/list» при получении списка задач. Фильтры задач задаются следующим набором параметров: 
