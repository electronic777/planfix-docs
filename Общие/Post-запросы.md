(перенаправлено с «[Post-запросы](../Прочее/index.php.md)»)


ПланФикс работает с HTTP-запросами через [автоматические сценарии](../Автоматизация/Автоматические_сценарии.md) и [вебхуки](Входящие_вебхуки.md), используя следующие методы: 
...
## Примеры HTTP-запросов и разбор ответов
  ...
  * [Приём HTTP-запросов при помощи входящих вебхуков](Входящие_вебхуки.md)
...
## Дополнительно
  ...
  * Поступающие в ПланФикс данные перед дальнейшим использованием можно дополнительно [обработать](Вычислить_инфоблок.md).
