Вы можете создать собственного бота [Telegram](Интеграции/Telegram.md) и подключить его в ПланФикс. Сообщения, отправленные такому боту вашими клиентами или коллегами, станут [ задачами](Задачи/Задачи.md) в ПланФиксе. Комментарии, добавленные в задачу с уведомлением внешнего абонента, будут отправлены ему в Telegram от имени бота. Это позволяет организовывать обработку заявок клиентов с мобильных устройств, работу службы поддержки и т.п. 
