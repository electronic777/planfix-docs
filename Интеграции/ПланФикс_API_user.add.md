...
role | enum | роль пользователя в системе | допустимые значения _ADMIN_ , **USER**. полный список смотри в разделе [роли пользователей](ПланФикс_API_Роли_пользователей.md)  
