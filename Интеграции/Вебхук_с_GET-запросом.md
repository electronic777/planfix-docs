Для того, чтобы понять как работают [вебхуки](Прочее/Входящие_вебхуки.md) с GET-запросом, сформируем ссылку, которая будет создавать новые задачи в ПланФиксе. 
