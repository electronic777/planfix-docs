...
handbook.id | int | идентификатор справочника | получается в результате выполнения функции [получить описание аналитики](Интеграции/ПланФикс_API_analitic.getOptions.md)  
