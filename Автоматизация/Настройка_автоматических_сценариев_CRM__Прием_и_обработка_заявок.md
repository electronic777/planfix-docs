...
Описанная автоматизация, работающая на базе [ автоматических сценариев](Автоматические_сценарии.md), может быть выключена или настроена для нужд именно вашей компании. Для этого: 
