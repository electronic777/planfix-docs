ПланФикс работает с HTTP-запросами через [автоматические сценарии](../Автоматизация/Автоматические_сценарии.md) и [вебхуки](../Общие/Входящие_вебхуки.md), используя следующие методы: 
...
## Примеры HTTP-запросов и разбор ответов
  ...
  * [GET-запрос: получение курса валют](GET-запрос__получение_курса_валют.md)

  * [POST-запрос: трекинг посылок](POST-запрос__трекинг_посылок.md)

  * [POST-запрос в ЮКассу: ссылка на оплату](POST-запрос_в_ЮКассу__ссылка_на_оплату.md)

  * [Приём HTTP-запросов при помощи входящих вебхуков](../Общие/Входящие_вебхуки.md)
