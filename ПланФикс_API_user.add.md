...
role | enum | роль пользователя в системе | допустимые значения _ADMIN_ , **USER**. полный список смотри в разделе [роли пользователей](ПланФикс_API_Роли_пользователей.md "ПланФикс API:Роли пользователей")  

post.id | int | идентификатор должности | не обязательное поле   

status | enum | статус пользователя | список допустимых значений смотри в разделе [статусы пользователей](ПланФикс_API_Статусы_пользователей.md "ПланФикс API:Статусы пользователей")  
