...
ПланФикс позволяет настроить получение [ уведомлений](Коммуникации/Подписки_и_уведомления.md) о новых задачах и комментариях в Skype. 


Для этого нужно зайти в свою [ карточку пользователя](Интерфейс/Страница_пользователя.md) и подписаться на Skype бота ПланФикс: 
