Вы можете [подключить](Интеграции.md) к ПланФиксу чат-ботов Viber для приема и обработки сообщений клиентов. 
...
## Возможности
  ...
  * Доступны [быстрые ответы](../Общие/Быстрые_ответы.md), для ответа на часто задаваемые вопросы клиентов.
