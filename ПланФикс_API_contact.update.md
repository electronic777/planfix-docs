...
group.id | int | идентификатор группы контактов | допустимые значения можно получить функцией [contact.getGroupList](ПланФикс_API_contact.getGroupList.md "ПланФикс API contact.getGroupList")  
