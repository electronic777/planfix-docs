...
role | enum | роль пользователя в системе | необязательное поле. доступно для изменения только пользователям с правами администратор. полный список смотри в разделе [роли пользователей](ПланФикс_API_Роли_пользователей.md)  
