(перенаправлено с «[Как добавить действие с помощью e-mail?](Общие/index.php.md)»)
...
Если ответ на комментарий придет с [email-адреса](Общие/Работа_в_ПланФиксе_с_помощью_e-mail.md), которого нет в вашем аккаунте, то: 
