Получение данных аналитики прикрепленной действием. Список доступных аналитик получают из [списка действий](ПланФикс_API_action.getList.md). Формат запроса: 
...
analiticKeys.key | int | идентификатор строки данных аналитики | возвращается функцией [action.get](ПланФикс_API_action.get.md)  
