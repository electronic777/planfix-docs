Функция позволяет получить список доступных текущему сотруднику фильтров задач для функции [task.getList](Интеграции/ПланФикс_API_task.getList.md). Формат вызова функции: 
